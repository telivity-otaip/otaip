...
const NYC_PROPERTIES: RawHotelResult[] = [
  {
    ...
    roomTypes: [
      {
        roomTypeId: 'HB-87234-STD',
        description: 'Standard Room King Bed',
        maxOccupancy: 2,
        bedTypeRaw: 'King Bed',
      },
      {
        roomTypeId: 'HB-87234-DLX',
        description: 'Deluxe Room King City View',
        maxOccupancy: 2,
        bedTypeRaw: 'King Bed',
      },
    ],
    ...
    photos: [
      {
        url: 'https://mock.hotelbeds.com/photos/87234/main.jpg',
        caption: 'Marriott Marquis',
        category: 'EXTERIOR',
      },
    ],
  ...
  },
  {
    ...
    roomTypes: [
      {
        roomTypeId: 'HB-65891-STD',
        description: 'Queen Guest Room',
        maxOccupancy: 2,
        bedTypeRaw: 'Queen',
      },
    ],
    rates: [
      {
        ...
        cancellationPolicy: {
          refundable: true,
          deadlines: [{ hoursBeforeCheckin: 48, penaltyType: 'percentage', penaltyValue: 100 }],
          freeCancel24hrBooking: true,
        },
        taxAmount: '49.00',
      },
    ...
    photos: [
      {
        url: 'https://mock.hotelbeds.com/photos/65891/main.jpg',
        caption: 'Hilton Midtown',
        category: 'EXTERIOR',
      },
    ],
...
const LON_PROPERTIES: RawHotelResult[] = [
  {
    ...
    roomTypes: [
      {
        roomTypeId: 'HB-12098-SUP',
        description: 'Superior King River View',
        maxOccupancy: 2,
        bedTypeRaw: 'King',
      },
    ],
    ...
    photos: [
      {
        url: 'https://mock.hotelbeds.com/photos/12098/exterior.jpg',
        caption: 'Savoy Hotel',
        category: 'EXTERIOR',
      },
    ],

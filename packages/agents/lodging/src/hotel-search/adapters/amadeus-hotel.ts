...
const NYC_PROPERTIES: RawHotelResult[] = [
  {
    ...
    chainName: 'Marriott',
    starRating: 4,
    amenities: ['Free WiFi', 'Fitness Center', 'Restaurant', 'Room Service', 'Business Center', 'Concierge'],
    roomTypes: [
      { roomTypeId: 'AMNYC001-STD-K', code: 'KNG', description: 'Standard King Room', maxOccupancy: 2, bedTypeRaw: 'King' },
      { roomTypeId: 'AMNYC001-DLX-K', code: 'KDLX', description: 'Deluxe King Room City View', maxOccupancy: 2, bedTypeRaw: 'King' },
    ],
    rates: [
      {
        rateId: 'AMNYC001-R1', roomTypeId: 'AMNYC001-STD-K', nightlyRate: '299.00', totalRate: '598.00',
    ...
    photos: [{ url: 'https://mock.amadeus.com/photos/AMNYC001/exterior.jpg', caption: 'Hotel Exterior', category: 'exterior' }],
    description: 'Located in the heart of Times Square, this iconic hotel offers modern rooms with stunning city views.',
  },
  {
    ...
    roomTypes: [
      { roomTypeId: 'AMNYC002-STD-Q', code: 'QN', description: 'Standard Queen Room', maxOccupancy: 2, bedTypeRaw: 'Queen' },
    ],
    rates: [
      {
        rateId: 'AMNYC002-R1', roomTypeId: 'AMNYC002-STD-Q', nightlyRate: '279.00', totalRate: '558.00',
        currency: 'USD', rateType: 'bar', paymentModel: 'pay_at_property',
        cancellationPolicy: { refundable: true, deadlines: [{ hoursBeforeCheckin: 48, penaltyType: 'nights', penaltyValue: 1 }], freeCancel24hrBooking: true },
        taxAmount: '49.72',
      },
    ],
    photos: [{ url: 'https://mock.amadeus.com/photos/AMNYC002/exterior.jpg', caption: 'Hotel Exterior', category: 'exterior' }],
    description: 'A modern Hilton hotel in midtown Manhattan, steps from Central Park and Rockefeller Center.',
  },
  {
    ...
    roomTypes: [
      { roomTypeId: 'AMNYC003-STD-K', code: 'KNG', description: 'King Room', maxOccupancy: 2, bedTypeRaw: 'King' },
    ],
    rates: [
      {
        rateId: 'AMNYC003-R1', roomTypeId: 'AMNYC003-STD-K', nightlyRate: '259.00', totalRate: '518.00',
    ...
    photos: [],
    description: 'Adjacent to Grand Central Terminal, this Hyatt offers convenient access to midtown Manhattan.',
  },
];
...
const LON_PROPERTIES: RawHotelResult[] = [
  {
    ...
    starRating: 5,
    amenities: ['Free WiFi', 'Spa', 'Pool', 'Restaurant', 'Bar', 'Fitness Center', 'Room Service', 'Concierge'],
    roomTypes: [
      { roomTypeId: 'AMLON001-SUP-K', code: 'KSUP', description: 'Superior King Room River View', maxOccupancy: 2, bedTypeRaw: 'King' },
    ],
    rates: [
      {
        rateId: 'AMLON001-R1', roomTypeId: 'AMLON001-SUP-K', nightlyRate: '650.00', totalRate: '1300.00',
        currency: 'GBP', rateType: 'bar', paymentModel: 'pay_at_property',
    ...
    photos: [{ url: 'https://mock.amadeus.com/photos/AMLON001/exterior.jpg', caption: 'The Savoy Exterior', category: 'exterior' }],

...
const NYC_PROPERTIES: RawHotelResult[] = [
  {
    ...
    chainName: 'Marriott',
    starRating: 4,
    amenities: ['WiFi included', 'Fitness centre', 'Dining', 'In-room service', 'Business facilities'],
    roomTypes: [
      { roomTypeId: 'duf_rm_001', description: 'King Bed Standard', maxOccupancy: 2, bedTypeRaw: 'King' },
    ],
    rates: [
      {
        rateId: 'duf_rate_001', roomTypeId: 'duf_rm_001', nightlyRate: '302.00', totalRate: '604.00',
        ...
        mandatoryFees: [{ type: 'facility_fee', amount: '25.00', currency: 'USD', perUnit: 'per_night' }],
        taxAmount: '53.72',
      },
    ],
    photos: [{ url: 'https://mock.duffel.com/stays/nyc0001/main.jpg', caption: 'Marriott Marquis NYC', category: 'exterior' }],
  ...
  },
  {
    ...
    roomTypes: [
      { roomTypeId: 'duf_rm_004', description: 'Full Pod Queen', maxOccupancy: 2, bedTypeRaw: 'Queen' },
    ],
    rates: [
      {
        rateId: 'duf_rate_004', roomTypeId: 'duf_rm_004', nightlyRate: '149.00', totalRate: '298.00',

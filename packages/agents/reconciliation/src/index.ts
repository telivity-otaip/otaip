...
export type { CommissionManagementInput, CommissionManagementOutput, CommissionAgreement, CommissionRate, CommissionValidationResult, IncentiveResult, AgreementType, CommissionBasis, ValidationStatus, CommissionOperation } from './commission-management/index.js';
...
export type { FinancialReportingInput, FinancialReportingOutput, FinancialReport, FinancialRecord, ReportLineItem, ReportTotals, FinReportType, RecordType, FinancialReportRequest } from './financial-reporting/index.js';

export { RevenueAccountingAgent } from './revenue-accounting/index.js';
export type { RevenueAccountingInput, RevenueAccountingOutput, LiftRecord, CouponLiftInput, RevenueRecognitionResult, UpliftReport, DeferredRevenueReport, CouponNumber, LiftStatus, RevAcctOperation } from './revenue-accounting/index.js';

...
export class GdsNdcRouter implements Agent<GdsNdcRouterInput, GdsNdcRouterOutput> {
  ...
  async execute(input: AgentInput<GdsNdcRouterInput>): Promise<AgentOutput<GdsNdcRouterOutput>> {
    if (!this.initialized) {
